...
export default function SignupPage() {
  ...
  const welcomeTexts = [
    'Swagat hai! Join us today 🙏',
    'Start your data journey',
    'Build smarter documentation',
    'Connect. Analyze. Succeed.',
  ]
        ...
        <div className="auth-info-content">
          ...
          <div className="auth-welcome">
            ...
            <p className="auth-tagline">
              Join thousands of data professionals transforming their database documentation workflow.
            </p>
          </div>
          ...
          <div className="auth-features">
            <div className="auth-feature">
              <Zap size={20} />
              <span>Lightning-fast schema extraction</span>
            </div>
            <div className="auth-feature">
              <TrendingUp size={20} />
      ...
      <div className="auth-form-panel">
        <div className="auth-form-container">
          <div className="auth-form-header">
            ...
            <p>Start your free journey with DataDict AI</p>
          </div>
